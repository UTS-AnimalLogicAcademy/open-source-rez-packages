...
rm KatanaUsdPlugins-$BUILD_VERSION/cmake/macros/compilePython.py
cp patch/SetupInterfaces.cmake KatanaUsdPlugins-$BUILD_VERSION/cmake/macros/compilePython.py
