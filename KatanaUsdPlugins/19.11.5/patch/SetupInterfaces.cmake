...
function(add_boost_interface)
    if(USE_KATANA_BOOST)
        ...
        set(BOOST_LIBRARYDIR /opt/Foundry/Katana3.6v2/bin)
        set(BOOST_INCLUDEDIR /opt/Foundry/Katana3.6v2/external/FnBoost/include)
                ...
                set_target_properties(TBB::tbb
                    PROPERTIES
                        INTERFACE_LINK_LIBRARIES
                            "${KATANA_API_LOCATION}/bin/libtbb.so.2"
                )
            elseif(WIN32)
                set_target_properties(TBB::tbb
                    PROPERTIES
...
function(add_usd_interface)
    if(USE_KATANA_USD)
        set(USD_LIBRARY_DIR /opt/Foundry/Katana3.6v2/bin)
        set(USD_INCLUDE_DIR /opt/Foundry/Katana3.6v2/external/FnUSD/include)
        if(UNIX)
