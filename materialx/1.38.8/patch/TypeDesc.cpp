...
{
   if(_name == other._name && _basetype == other._basetype && _semantic == other._semantic && _size == other._size && _editable == other._editable && _channelMapping == other._channelMapping)
     return true;
   else
     return false;
}
